...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-14 16:11`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/64dfabf6-9fb0-4c93-a3c3-69ef5c1034bd.git
$ cd 64dfabf6-9fb0-4c93-a3c3-69ef5c1034bd
```
